/*code for showing family relation through prolog language*/ 
male(dashrath). 
male(ram).
male(luv).
male(laxman).
...
wife(sita, ram). 
/*syntax for sita is wife of ram and ended by fullstop*/
wife(laxman, urmila).
...
/*for being mother she should be wife of the childrens father*/
